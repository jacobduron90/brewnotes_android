...
class CheckInManager constructor(){
    ...
    private fun hydrateRecommendations () {
        ...
        checkins?.add(CheckIn("12312l", "cuvee", "/img/grizz.jpg", "john bob", "http://www.iconsfind.com/wp-content/uploads/2015/10/20151012_561baed03a54e.png", recommendation1))
        ...
        checkins?.add(CheckIn("12312l", "purty", "/img/caffe_luxe.jpg", "john bob", "https://cdn3.iconfinder.com/data/icons/glypho-generic-icons/64/user-woman-512.png", recommendation3))
    }
